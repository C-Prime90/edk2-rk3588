...
[PcdsFixedAtBuild.common]
  ...
  gRockchipTokenSpaceGuid.PcdI2cSlaveBusesRuntimeSupport|{ FALSE, FALSE, TRUE, TRUE }
  ...
  # This port can supply an attached device (GPIO4_PB2). The driver only
  ...
  gRockchipTokenSpaceGuid.PcdFusb302VbusGpioPin|10
  ...
  # DisplayPort AUX SBU switches (GPIO4_A6 / GPIO4_A7), thrown per plug orientation.
